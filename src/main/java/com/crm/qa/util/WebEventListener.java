...
public class WebEventListener extends TestBase implements WebDriverListener 
{
    ...
    */
    ...
    try {
			...
			TestUtil.takeScreenshotAtEndofTest(driver, methodName);
    	} catch (IOException e)
    {
        e.printStackTrace();
    	}
	    ...
	    public void onError(Object target, Method method, Object[] args, InvocationTargetException e) 
	 {
	       // WebDriverListener.super.onError(target, method, args, e);
	        ...
	        System.err.println("An error occurred while executing method: " + method.getName());
	        e.printStackTrace();
	 }
    ...
    public void beforeGet(WebDriver driver, String url) {
        ...
        System.out.println("beforeGet--------> "+url);
    }

    @Override
    public void afterGet(WebDriver driver, String url) {
        WebDriverListener.super.afterGet(driver, url);
        System.out.println("afterGet--------> "+url);
    }
...
*/
    ...
    public void afterGetTitle(WebDriver driver, String result) {
        ...
        System.out.println("afterGetTitle=========> "+result);
...
*/
    ...
    public void beforeSendKeys(WebElement element, CharSequence... keysToSend) {
        ...
        System.out.println("beforeSendKeys--------> "+keysToSend);
    ...
    public void afterSendKeys(WebElement element, CharSequence... keysToSend) {
        ...
        System.out.println("afterSendKeys--------> "+keysToSend);
       // Log.info("Element writed: " + element);
    }
...
*/
    ...
    public void beforeSendKeys(Alert alert, String text) {
        ...
        System.out.println("beforeSendKeys--->"+alert + "_____" + text);
    }

    @Override
    public void afterSendKeys(Alert alert, String text) {
        WebDriverListener.super.afterSendKeys(alert, text);
        System.out.println("afterSendKeys--->"+alert + "_____" + text);
    }
/*
    @Override
...
*/
    ...
    // Implement other methods as needed (beforeFindBy, afterFindBy, etc.)
}